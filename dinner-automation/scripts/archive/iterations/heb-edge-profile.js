...
async function addItemsToHEBWithProfile() {
  console.log('🛒 Connecting to your Edge profile...\n');
  
  // Launch Edge with your profile and remote debugging
...
addItemsToHEBWithProfile().catch(console.error);
