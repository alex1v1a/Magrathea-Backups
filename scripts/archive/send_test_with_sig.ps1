...
try {
    ...
    $Body = "This is a test email to verify the signature and email configuration.<br><br>Please review the signature below and let me know if any changes are needed."
