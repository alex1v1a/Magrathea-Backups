...
<p>Your Vectarr email signature is ready. Please follow these instructions to install it in Outlook:</p>

<h3 style="color:#000;">Installation Instructions:</h3>
<ol>
<li><strong>Save the attached HTML file</strong> to your computer</li>
...
<li><strong>Copy and paste</strong> the HTML content from the file into the signature editor</li>
