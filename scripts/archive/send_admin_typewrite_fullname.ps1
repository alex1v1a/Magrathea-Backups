# Outlook Email Test Script for admin@typewrite.club with full name
param(
    [string]$To = "alex@1v1a.com",
    [string]$From = "admin@typewrite.club",
    [string]$Subject = "Test Email - TypeWrite Club Admin (Full Name)"
)
...
try {
    ...
    $Body = "This is a test email from admin@typewrite.club with the updated full name signature.<br><br>The name should now show 'Alexander Sferrazza'."
