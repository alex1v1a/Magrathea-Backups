# Outlook Email Test Script for admin@typewrite.club with authenticated Imgur logo
param(
    [string]$To = "alex@1v1a.com",
    [string]$From = "admin@typewrite.club",
    [string]$Subject = "Test Email - TypeWrite Club Admin (Authenticated Imgur)"
)
...
try {
    ...
    $Body = "This is a test email from admin@typewrite.club with the logo uploaded to your Imgur account (Alex1v1a).<br><br>The logo is now hosted at: https://i.imgur.com/MvQAlV5.png"
